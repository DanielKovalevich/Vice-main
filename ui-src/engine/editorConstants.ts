 ...
 *
 * Names, descriptions and sample text live in the locale files under
 * editor.fx.<id> and editor.textPreset.<id>, keyed by the ids here, so a
 * translated editor needs no change to this table.
 */
export const ED_FX = [
  {
    id: 'crossfade',
...
export const ED_TEXT_PRESETS = [
  {id: 'title', font: 'display', size: 64, weight: 600, color: '#f2f5fa', x: 50, y: 44},
  {id: 'subtitle', font: 'body', size: 34, weight: 500, color: '#dbe1ea', x: 50, y: 58},
  {id: 'caption', font: 'mono', size: 22, weight: 400, color: '#b8c0cd', x: 50, y: 88},
  {id: 'lower', font: 'display', size: 40, weight: 600, color: '#f2f5fa', x: 22, y: 84},
] as const;
...
export const fxName = (id: string) => translate(`editor.fx.${id}.name`);
